...
We believe that **Accessibility should not require an Internet Connection.** * By hosting the server locally via "Internet Sharing," we ensure that users in "Dead Zones" or secure facilities still have access to live captions.
